...
ol.control.MeasureTool = function(opt_options) {
  ...
  html += '<li><input type="button" value="线"></li>';
  html += '<li><input type="button" value="面"></li>';
...
ol.control.MeasureTool.prototype.mapmeasure = function(typeSelect) {
  ...
  function createHelpTooltip() {
    ...
    helpTooltipElement.className = 'tooltip-m hidden';
  }
  function createMeasureTooltip() {
    ...
    if(measureTooltip === null || measureTooltip === undefined )  {//pmy
...
//    map.getOverlays().clear();       //会把其他的也清空
	map.removeOverlay(measureTooltip); //pmy
