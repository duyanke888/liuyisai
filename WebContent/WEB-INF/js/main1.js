...
//********************************************************************************************
    ...
    drawFeatures(map);/**利用drawFeature(map)函数画点和线，方法：两个ajax嵌套 */
    ...
    function drawFeatures(map) {
        $.ajax({
            ...
            success:function(data){
                ...
                successLoadPoint(data);//成功读取   点  的JSON文件后加载此函数
                getLine(map);
            }//end success function
        })//end ajax
    }//end drawFeatures(map)

    function successLoadPoint(data){        //成功读取   点  的JSON文件后加载此函数
        ...
        function successLoadLine(data){         //成功读取   线  的JSON文件后加载此函数
